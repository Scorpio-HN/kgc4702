...
public class UsersController {
    ...
    public Users login(String uname, String upwd){
        System.out.println("提供者9092---login:::"+uname+"::::"+upwd);
      return  usersService.login(uname,upwd);
    }

    @RequestMapping("/showAll")
    public List<Users> showAll(){
        System.out.println("提供者9092---showAll:::");
    ...
    public int addUsers(@RequestBody Users users){
        System.out.println("提供者9092---addUsers:::"+users);
    ...
    public String testSession(HttpSession session){
        ...
        System.out.println("提供者9092===>>>sessionId:"+id+":::uname:"+uname);
