...
public abstract class MongoDbDao<T> {
    ...
    public void save(T t) {
        System.out.print("-------------->MongoDB save start");
    ...
    public T queryById(Integer id) {
        ...
        T one = this.mongoTemplate.findOne(query, this.getEntityClass());
    ...
    public List<T> queryList(T object) {
        ...
        System.out.print("-------------->MongoDB find start");
    ...
    public List<T> getPage(T object, int start, int size) {
        ...
        query.skip(start);
        query.limit(size);
        System.out.print("-------------->MongoDB queryPage start");
    ...
    public Long getCount(T object) {
        Query query = getQueryByObject(object);
        System.out.print("-------------->MongoDB Count start");
    ...
    public int delete(T t) {
        System.out.print("-------------->MongoDB delete start");
    ...
    public void deleteById(Integer id) {
        ...
        if (null != criteria) {
            ...
            System.out.print("-------------->MongoDB deleteById start");
            if (obj != null) {
                this.delete(obj);
            }
        }
    ...
    public void updateFirst(T srcObj, T targetObj){
        ...
        System.out.print("-------------->MongoDB updateFirst start");
    ...
    public void updateInsert(T srcObj, T targetObj){
        Query query = getQueryByObject(srcObj);
        Update update = getUpdateByObject(targetObj);
        System.out.print("-------------->MongoDB updateInsert start");
